...
export default function Home() {
  return (
    <div className="relative bg-brandWhite z-0">
      ...
      <RedLine className="top-610 scale-600 md:scale-150 -rotate-55 md:-rotate-15"/>
      <BlueLine className="block md:hidden scale-450 md:scale-150 top-750 rotate-55"/>
      <RedLine className="block md:hidden top-900 scale-450 "/>
      <BlueLine className="hidden md:block md:scale-130 rotate-5 md:top-1050"/>
      ...
      <div className="flex min-h-screen max-w-screen-lg flex-col items-center justify-between mx-auto gap-15 p-5 z-1">
          <Header/>
          <Hero/>
          <Problem/>
          <Solution/>
