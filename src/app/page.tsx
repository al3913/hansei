  ...
  return (
    <div className="relative bg-brandWhite z-0 overflow-x-hidden">
      <div className="absolute inset-0 z-[-1] -mt-15">
        ...
        <BlueLine className="hidden md:block md:scale-110 rotate-5 md:top-1048"/>
      ...
      <div className="flex min-h-screen max-w-screen-lg flex-col items-center justify-between mx-auto gap-15 pt-30 p-5 z-1">
